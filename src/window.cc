...
Window::Window(QWidget *parent) :
		QWidget(parent), ui(new Ui::Window), flags_ { path_to_vocabulary,
				path_to_settings }, openmapper_engine_(
				new openmapper::OpenMapper(flags_)) {
	ui->setupUi(this);
...
void Window::timerEvent(QTimerEvent *event) {
	...
	bool tracking = openmapper_engine_->trackImage(img,
